...
local function RLJCMYP_fake_script() -- STATPage.LocalScript 
...
coroutine.wrap(RLJCMYP_fake_script)()
local function BDQEJ_fake_script() -- INVPage.LocalScript 
...
coroutine.wrap(BDQEJ_fake_script)()
local function IIUOI_fake_script() -- RADIOPage.LocalScript 
...
coroutine.wrap(IIUOI_fake_script)()
local function KVUVBY_fake_script() -- PlayerImage.LocalScript 
...
coroutine.wrap(KVUVBY_fake_script)()
local function VWABI_fake_script() -- Speed.LocalScript 
...
coroutine.wrap(VWABI_fake_script)()
local function MGOUU_fake_script() -- HP.LocalScript 
...
coroutine.wrap(MGOUU_fake_script)()
local function JWGWC_fake_script() -- Inv.Inventory 
...
coroutine.wrap(JWGWC_fake_script)()
-- Example.ItemScript is disabled.
local function BABBF_fake_script() -- DiamondCityRadio.Script 
...
coroutine.wrap(BABBF_fake_script)()
-- PipBoyGui.OpenAndClose is disabled.
